CREATE VIEW MDVIEW_RESULT_HISTORICO
AS
...
FROM obtenerDatosEmpresaActualResultadosHistorico() datos FULL JOIN ObtenerMadurezResultadosHistorico() c1
ON datos.ruc = c1.ruc
FULL JOIN ObtenerMadurezDigitalTotalActualResultadosHistorico() ctotal
