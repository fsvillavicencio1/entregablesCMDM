...
CREATE FUNCTION obtenerDatosEmpresaActualResultadosHistorico()
RETURNS TABLE
AS
RETURN(
    SELECT
...
CREATE FUNCTION ObtenerMadurezResultadosHistorico()
RETURNS TABLE
AS
RETURN(
    SELECT 
...
CREATE FUNCTION ObtenerMadurezDigitalTotalActualResultadosHistorico()
RETURNS TABLE
AS
RETURN(
    SELECT (
