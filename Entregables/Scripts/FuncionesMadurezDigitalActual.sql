...
CREATE FUNCTION obtenerDatosEmpresaActual()
RETURNS TABLE
AS
RETURN(
    SELECT
...
CREATE FUNCTION ObtenerMadurezDigital1Actual()
RETURNS TABLE
AS
RETURN(
    SELECT (
...
CREATE FUNCTION ObtenerMadurezDigital2Actual()
RETURNS TABLE
AS
RETURN(
    SELECT (
...
CREATE FUNCTION ObtenerMadurezDigital3Atual()
RETURNS TABLE
AS
RETURN(
    SELECT (
...
CREATE FUNCTION ObtenerMadurezDigital4Actual()
RETURNS TABLE
AS
RETURN(
    SELECT (
...
CREATE FUNCTION ObtenerMadurezDigitalTotalActual()
RETURNS TABLE
AS
RETURN(
    SELECT (
